...
// Konstruktor:
MinefieldHex::MinefieldHex( const MinefieldData &cells ) : MinefieldNonclassic( 7, cells ) {}
MinefieldHex::MinefieldHex( const std::size_t rowsCount, const std::size_t columnsCount, const std::size_t minesCount ) : MinefieldHex( MinefieldData( rowsCount, columnsCount, minesCount ) ) {}
// Pomocnicze metody chronione:
MinefieldHex::tColumnsBoundsSet MinefieldHex::findAdjacentCellsColumnsBounds( const std::size_t centerRow, const std::size_t centerColumn ) const {
