...
void print_minefield( MinefieldHex &minefield ) {
...
int main() {
  ...
  if( saveManager.isSaveDataLoadedFromFile() ) {
    MinefieldHex minefield( saveManager.load() );
    ...
    */
    ...
    boost::random::mt19937 generator( 42 /*random_device()*/ );
    ...
    MinefieldHex minefield( rowsCount, columnsCount, minesCount );
